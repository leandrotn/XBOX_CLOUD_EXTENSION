...
function Popup() {
    ...
    const paymentStatus = (0, reduxHooks_1.useAppSelector)(selectors_1.getPaymentStatus);
    return (react_2.default.createElement("div", { className: (0, classnames_1.default)('popup vertical', paymentStatus !== 'success' && 'centered') }, paymentStatus === 'success' ? (react_2.default.createElement(react_2.default.Fragment, null,
        react_2.default.createElement(Header_1.default, { activeConfig: activeConfig, isEnabled: isEnabled, gameName: gameName }),
        react_2.default.createElement(MainConfigEditor_1.default, { activeConfig: activeConfig, isEnabled: isEnabled, status: status, configs: configs, error: error }),
        react_2.default.createElement(UpsellModal_1.default, null))) : paymentStatus === 'failure' ? (react_2.default.createElement("div", { className: "error" },
        react_2.default.createElement("p", null, "Unable to load payment details. Please close and reopen this window to try again."))) : (react_2.default.createElement(react_1.Spinner, { size: react_1.SpinnerSize.large }))));
}
...
function GamepadConfigSelector({ className, currentConfig, activeConfig, isEnabled, allConfigs, setCurrentConfig, addNewConfig, importConfig, toggleShowSettings, }) {
    ...
    return isNew ? (react_1.default.createElement("div", { className: rootCssClasses },
        ...
        react_1.default.createElement("div", { className: "horizontal" },
            ...
            react_1.default.createElement(NewConfigButton_1.default, { disabled: configsArray.length >= gamepadConfig_1.MAX_NUM_CONFIGS - 1, allConfigs: allConfigs, onCreate: addNewConfig, onImport: importConfig }),
...
function HeaderMoreOptions() {
    ...
    return (react_2.default.createElement("div", { className: "relative" },
        react_2.default.createElement(react_1.IconButton, { menuProps: {
                items: menuItems,
        ...
        !payment.paid ? react_2.default.createElement("div", { className: "unpaid-dot" }) : null));
}
...
function MainConfigEditor({ activeConfig, isEnabled, configs, status, error }) {
    ...
    return (react_1.default.createElement("div", { className: "box margin-full vertical full-height" }, status === 'failure' ? (react_1.default.createElement(ErrorDetails_1.default, { error: error })) : status !== 'success' ? (react_1.default.createElement(react_2.Spinner, { size: react_2.SpinnerSize.large })) : (react_1.default.createElement("div", { className: "vertical full-height", style: { position: 'relative' } }, showSettings ? (react_1.default.createElement(GlobalPrefsEditor_1.default, { goBack: toggleShowSettings })) : (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(GamepadConfigSelector_1.default, { className: "padding-bottom-s", isEnabled: isEnabled, activeConfig: activeConfig, currentConfig: currentConfig, allConfigs: configs, setCurrentConfig: setCurrentConfig, addNewConfig: handleAddNewConfig, importConfig: handleSubmitGamepadConfig, toggleShowSettings: toggleShowSettings }),
...
const buttonStyles = { root: { width: '100%' }, textContainer: { textAlign: 'center' } };
const doAndThenCloseWindow = (promise) => __awaiter(void 0, void 0, void 0, function* () {
    yield promise;
    setTimeout(() => {
        window.close();
    }, 100);
...
function UpsellModal() {
    ...
    const trialState = (0, reduxHooks_1.useAppSelector)(selectors_1.getTrialState);
    const isAllowed = (0, reduxHooks_1.useAppSelector)(selectors_1.getIsAllowed);
    const openPaymentPage = (0, react_2.useCallback)(() => {
        doAndThenCloseWindow(extpay.openPaymentPage());
    }, []);
    const openTrialPage = (0, react_2.useCallback)(() => {
        doAndThenCloseWindow(extpay.openTrialPage(`${trial_1.trialDays} day`));
    }, []);
    const openLoginPage = (0, react_2.useCallback)(() => {
    ...
    return (react_2.default.createElement(react_responsive_modal_1.Modal, { center: true, open: show || !isAllowed, onClose: handleClose, showCloseIcon: isAllowed, focusTrapped: true, closeOnEsc: isAllowed },
        react_2.default.createElement("div", { className: "explanation-modal-xmnk" },
            react_2.default.createElement("h2", { style: { lineHeight: '1.3em' } }, "Control any game on xCloud with keyboard and mouse"),
            react_2.default.createElement("p", null,
                react_2.default.createElement("strong", null, "Pay once \u2014 use all features, forever!")),
            react_2.default.createElement("ul", null,
                react_2.default.createElement("li", null, "Switch between mouse/keyboard and controller with one click of a toggle"),
                react_2.default.createElement("li", null,
                    "Create your own presets for different games, or import",
                    ' ',
                    react_2.default.createElement(react_1.Link, { underline: true, href: "https://discord.gg/5Jp9drge9m", target: "_blank", rel: "external nofollow noopener noreferrer" }, "community-made presets")),
                react_2.default.createElement("li", null, "Manage mouse sensitivity per profile"),
                react_2.default.createElement("li", null, "No added input delay - all keyboard/mouse input is instantly translated into virtual controller input"),
                react_2.default.createElement("li", null, "More features coming soon")),
            react_2.default.createElement(react_1.Stack, { horizontal: true, tokens: stackTokens, style: { marginTop: '20px' } },
                react_2.default.createElement(react_1.Stack.Item, { grow: true },
                    react_2.default.createElement(react_1.CompoundButton, { disabled: trialState.status !== 'inactive', secondaryText: `${trialState.remainingDays} day(s) remaining`, onClick: openTrialPage, styles: buttonStyles }, trialState.status === 'inactive'
                        ? 'Start Trial'
                        : trialState.status === 'expired'
                            ? 'Trial Expired'
                            : 'Trial Active')),
                react_2.default.createElement(react_1.Stack.Item, { grow: true },
                    react_2.default.createElement(react_1.CompoundButton, { primary: true, secondaryText: `Only ${price}`, onClick: openPaymentPage, styles: buttonStyles }, "Upgrade Now"))),
            react_2.default.createElement("div", { style: { fontSize: '0.8em', textAlign: 'right' } },
                react_2.default.createElement(react_1.Link, { onClick: openLoginPage }, "Already paid?")))));
}
...
function _setActiveConfig(name, state) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(0, selectors_1.getIsAllowed)(state))
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getGlobalPrefs = exports.getUpsellModalVisibility = exports.getIsAllowed = exports.getTrialState = exports.getPaymentStatus = exports.getPayment = exports.getGameName = exports.isConfigActive = exports.getActiveConfigName = exports.getIsEnabled = exports.getGamepadConfig = exports.getAllGamepadConfigs = void 0;
const payments_1 = __webpack_require__(72133);
const trial_1 = __webpack_require__(42748);
...
const getTrialState = (state) => {
    return (0, trial_1.computeTrialState)((0, exports.getPayment)(state).trialStartedAt);
};
exports.getTrialState = getTrialState;
const getIsAllowed = (state) => {
    const trialState = (0, exports.getTrialState)(state);
    const payment = (0, exports.getPayment)(state);
