    ...
    (0, chromeStoredData_1.getAllStoredSync)().then(({ activeConfig, configs, prefs }) => {
        ...
        if (command === 'show-hide-cheatsheet') {
            ...
            userPromise.then((user) => {
                if (user.paid || (0, trial_1.computeTrialState)(user.trialStartedAt).status === 'active') {
...
chrome.runtime.onMessage.addListener((msg, sender, sendResponse) => {
    ...
    if (msg.type === messages_1.MessageTypes.INITIALIZED) {
        ...
        Promise.all([(0, chromeStoredData_1.getAllStoredSync)(), extpay.getUser()]).then(([stored, user]) => {
    ...
    if (msg.type === messages_1.MessageTypes.SEEN_ONBOARDING) {
        ...
        extpay.getUser().then((user) => {
            ...
            const trialState = (0, trial_1.computeTrialState)(user.trialStartedAt);
